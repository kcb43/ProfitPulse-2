      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="w-[95vw] sm:w-[90vw] max-w-[95vw] max-h-[100vh] sm:max-h-[90vh] p-0 overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 flex flex-col">
          ...
          <div className="flex flex-col md:flex-row h-auto md:flex-1 overflow-y-auto md:overflow-hidden min-h-0 pb-0">
            ...
            {/* Main Content */}
            <div className="w-full md:flex-1 flex flex-col min-w-0 px-2 pb-0 sm:p-4 h-[250px] md:h-full overflow-hidden mt-auto md:mt-0 mb-0" style={{ background: isCropping ? '#f8fafc' : 'transparent' }}>
              <div 
