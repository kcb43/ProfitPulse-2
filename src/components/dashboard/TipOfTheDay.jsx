...
export default function TipOfTheDay({ variant }) {
  ...
  if (variant === "banner") {
    return (
      <div className="flex items-center gap-3 rounded-xl border border-yellow-200/70 dark:border-yellow-800/50 bg-yellow-50 dark:bg-yellow-900/20 px-3 py-2 max-w-[520px]">
        <div className="h-9 w-9 rounded-lg bg-yellow-200/60 dark:bg-yellow-800/40 flex items-center justify-center flex-shrink-0">
          <Lightbulb className="w-5 h-5 text-yellow-700 dark:text-yellow-300" />
        </div>
  ...
  return (
    <Card className="border-0 shadow-sm bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 lg:h-auto h-full flex flex-col">
      ...
      <CardContent className="p-6 pt-0 flex flex-col lg:h-auto h-full">
