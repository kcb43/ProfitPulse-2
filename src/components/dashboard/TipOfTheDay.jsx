...
export default function TipOfTheDay() {
  ...
  return (
    <Card className="border-0 shadow-sm bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 lg:h-auto h-full flex flex-col">
      <CardContent className="p-6 lg:pb-6 pb-3 flex flex-col lg:h-auto h-full">
        ...
        <div className="hidden lg:block border-t border-yellow-300 dark:border-yellow-700 pt-3">
